...
namespace Vulkan
{
	...
	namespace TODO
	{
		...
		enum class EStructureType : uint32_t
		{
            ...
            BufferMemory_RequirementsInfo2 =  VK_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2 ,
            ImageMemory_RequirementsInfo2 = VK_STRUCTURE_TYPE_IMAGE_MEMORY_REQUIREMENTS_INFO_2 ,
            ImageSparseMemory_RequirementsInfo2 = VK_STRUCTURE_TYPE_IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2 ,
            MemoryRequirements2 = VK_STRUCTURE_TYPE_MEMORY_REQUIREMENTS_2 ,
            SparseImage_MemoryRequirements2 = VK_STRUCTURE_TYPE_SPARSE_IMAGE_MEMORY_REQUIREMENTS_2 ,
